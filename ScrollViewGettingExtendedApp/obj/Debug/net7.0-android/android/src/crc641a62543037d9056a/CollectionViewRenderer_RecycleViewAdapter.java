...
public class CollectionViewRenderer_RecycleViewAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Sharpnado.CollectionView.Droid.Renderers.CollectionViewRenderer+RecycleViewAdapter, Sharpnado.CollectionView.Maui", CollectionViewRenderer_RecycleViewAdapter.class, __md_methods);
	}


	public CollectionViewRenderer_RecycleViewAdapter ()
	{
		super ();
		if (getClass () == CollectionViewRenderer_RecycleViewAdapter.class) {
			mono.android.TypeManager.Activate ("Sharpnado.CollectionView.Droid.Renderers.CollectionViewRenderer+RecycleViewAdapter, Sharpnado.CollectionView.Maui", "", this, new java.lang.Object[] {  });
		}
	}
