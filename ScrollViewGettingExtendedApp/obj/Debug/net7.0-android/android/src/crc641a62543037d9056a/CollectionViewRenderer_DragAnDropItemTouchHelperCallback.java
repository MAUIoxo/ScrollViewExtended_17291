...
public class CollectionViewRenderer_DragAnDropItemTouchHelperCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Sharpnado.CollectionView.Droid.Renderers.CollectionViewRenderer+DragAnDropItemTouchHelperCallback, Sharpnado.CollectionView.Maui", CollectionViewRenderer_DragAnDropItemTouchHelperCallback.class, __md_methods);
	}


	public CollectionViewRenderer_DragAnDropItemTouchHelperCallback ()
	{
		super ();
		if (getClass () == CollectionViewRenderer_DragAnDropItemTouchHelperCallback.class) {
			mono.android.TypeManager.Activate ("Sharpnado.CollectionView.Droid.Renderers.CollectionViewRenderer+DragAnDropItemTouchHelperCallback, Sharpnado.CollectionView.Maui", "", this, new java.lang.Object[] {  });
		}
	}
